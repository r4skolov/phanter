...
function slider(el, config) {
  ...
  const settings = {
    modules: [Navigation, Pagination, Mousewheel, Parallax, freeMode],
    loop: false,
    slidesPerView: 'auto',
    spaceBetween: 0,
    preloadImages: false,
...
const workSlider = document.querySelectorAll('[data-slider="work-slider"]');
workSlider.forEach(item => slider(item, {
  slidesPerView: 'auto',
  rewind: false,
  autoHeight: true,
  centeredSlides: true,
...
const labsSlider = document.querySelectorAll('[data-slider="labs-slider"]');
labsSlider.forEach(item => slider(item, {
  slidesPerView: 'auto',
  rewind: false,
  autoHeight: true,
  centeredSlides: true,
  ...
  speed: 900,
  navigation: {
    nextEl: '.swiper-labs-next',
    prevEl: '.swiper-labs-prev'
  }
}));
/******/ })()
;
